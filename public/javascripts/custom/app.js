(function(){
  ...
  cliqueApp.config(function($stateProvider, $urlRouterProvider) {
    $stateProvider
      .state('main', { // route to show our main page (/)
        url: '/',
        templateUrl: '/public/partials/buyer_main.html',
        controller: 'MainController'
      })
      .state('review', { // review page (/review)
        url: '/review',
        templateUrl: '/public/partials/buyer_review.html',
        controller: 'ReviewController'
      })
      .state('final', { // final overlay (/final)
        url: '/final',
        templateUrl: '/public/partials/buyer_final.html',
  ...
  cliqueApp.controller('BuyerController', function($scope, $http, $location){
    ...
    // need to understand how to change this to what i use.
    $scope.formData = {
      To: '',
      From: '',
      Amount: '',
      ...
      if ($scope.pagesValid.main && $scope.pagesValid.review) {
        ...
        var handleResponse = function(response) {
          ...
          if (response.status_code === 201) {
            ...
            postObj.fundingInstrument = fundingInstrument;// I think this is adding fundingInstrument to the file
            postObj.uniqueLink = cardId;// same with this one too.

            // create Buyer and upon POST success create Recipient
            // found it V this is what I was looking for.
  ...
  cliqueApp.controller('MainController', function ($scope, TextService, OccasionService, api){
    ...
    **********/
    ...
    $scope.occasions.selectedIcon = '../public/images/occasion-custom-icon-blk.png';
    ...
    **********/
    // set default img
    $scope.dateTypeImg = '../public/images/send-today-blk.png';
    ...
    $scope.setDateType = function(type) {
      if(type=='today')
        ...
        $scope.dateTypeImg = '../public/images/send-on-date-blk.png';
    ...
    **********/
    ...
    // set default img
    $scope.cardTypeImg = '../public/images/cc-basic-blk.png';
    ...
    $scope.updateCreditCardImg = function(){
      ...
      if(acceptedTypes.indexOf(type) != -1)
        $scope.cardTypeImg = '../public/images/cc-' + type;
      else
        $scope.cardTypeImg = '../public/images/cc-basic';
    ...
    var occasions = [
      {
        name: 'birthday',
        images: {
          normal: '../public/images/occasion-birthday-icon-wht.png',
          selected: '../public/images/occasion-birthday-icon-blk.png'
        },
        alt: 'Birthday',
      ...
      },
      {
        name: 'anniversary',
        images: {
          normal: '../public/images/occasion-anniversary-icon-wht.png',
          selected: '../public/images/occasion-anniversary-icon-blk.png'
        },
        alt: 'Anniversary',
      ...
      },
      {
        name: 'love',
        images: {
          normal: '../public/images/occasion-love-icon-wht.png',
          selected: '../public/images/occasion-love-icon-blk.png'
        },
        alt: 'I Love You',
      ...
      },
      {
        name: 'getwell',
        images: {
          normal: '../public/images/occasion-getwell-icon-wht.png',
          selected: '../public/images/occasion-getwell-icon-blk.png'
        },
        alt: 'Get Well',
      ...
      },
      {
        name: 'congrats',
        images: {
          normal: '../public/images/occasion-congrats-icon-wht.png',
          selected: '../public/images/occasion-congrats-icon-blk.png'
        },
        alt: 'Congrats',
      ...
      },
      {
        name: 'wedding',
        images: {
          normal: '../public/images/occasion-wedding-icon-wht.png',
          selected: '../public/images/occasion-wedding-icon-blk.png'
        },
        alt: 'Wedding',
      ...
      },
      {
        name: 'baby',
        images: {
          normal: '../public/images/occasion-baby-icon-wht.png',
          selected: '../public/images/occasion-baby-icon-blk.png'
        },
        alt: 'Baby',
      ...
      },
      {
        name: 'sympathy',
        images: {
          normal: '../public/images/occasion-sympathy-icon-wht.png',
          selected: '../public/images/occasion-sympathy-icon-blk.png'
        },
        alt: 'Sympathy',
      ...
      },
      {
        name: 'thankyou',
        images: {
          normal: '../public/images/occasion-thankyou-icon-wht.png',
          selected: '../public/images/occasion-thankyou-icon-blk.png'
        },
        alt: 'Thank You',
      ...
      },
      {
        name: 'custom',
        images: {
          normal: '../public/images/occasion-custom-icon-wht.png',
          selected: '../public/images/occasion-custom-icon-blk.png'
        },
        alt: 'Custom',
