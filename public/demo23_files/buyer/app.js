(function(){
  ...
  cliqueApp.config(function($stateProvider, $urlRouterProvider) {
    $stateProvider
      .state('main', { // route to show our main page (/)
        url: '/',
        templateUrl: '../public/demo23_files/buyer/partials/main.html',
        controller: 'MainController'
      })
      .state('review', { // review page (/review)
        url: '/review',
        templateUrl: '../public/demo23_files/buyer/partials/review.html',
        controller: 'ReviewController'
      })
      .state('final', { // final overlay (/final)
        url: '/final',
        templateUrl: '../public/demo23_files/buyer/partials/final.html',
  ...
  cliqueApp.controller('MainController', function($scope, TextService, OccasionService){
    ...
    **********/
    ...
    $scope.occasions.selectedIcon = '../public/demo23_files/buyer/images/occasion-custom-icon-blk.png';
    ...
    **********/
    // set default img
    $scope.dateTypeImg = '../public/demo23_files/buyer/images/send-today-blk.png';
    ...
    $scope.setDateType = function(type) {
      if(type=='today')
        ...
        $scope.dateTypeImg = '../public/demo23_files/buyer/images/send-on-date-blk.png';
    ...
    **********/
    ...
    // set default img
    $scope.cardTypeImg = '../public/demo23_files/buyer/images/cc-basic-blk.png';
    ...
    $scope.updateCreditCardImg = function(){
      ...
      if(acceptedTypes.indexOf(type) != -1)
        $scope.cardTypeImg = '../public/demo23_files/buyer/images/cc-' + type;
      else
        $scope.cardTypeImg = '../public/demo23_files/buyer/images/cc-basic';      
    ...
    var occasions = [
      {
        name: 'birthday',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-birthday-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-birthday-icon-blk.png'
        },
        alt: 'Birthday',
      ...
      },
      {
        name: 'anniversary',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-anniversary-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-anniversary-icon-blk.png'
        },
        alt: 'Anniversary',
      ...
      },
      {
        name: 'love',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-love-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-love-icon-blk.png'
        },
        alt: 'I Love You',
      ...
      },
      {
        name: 'getwell',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-getwell-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-getwell-icon-blk.png'
        },
        alt: 'Get Well',
      ...
      },
      {
        name: 'congrats',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-congrats-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-congrats-icon-blk.png'
        },
        alt: 'Congrats',
      ...
      },
      {
        name: 'wedding',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-wedding-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-wedding-icon-blk.png'
        },
        alt: 'Wedding',
      ...
      },
      {
        name: 'baby',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-baby-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-baby-icon-blk.png'
        },
        alt: 'Baby',
      ...
      },
      {
        name: 'sympathy',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-sympathy-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-sympathy-icon-blk.png'
        },
        alt: 'Sympathy',
      ...
      },
      {
        name: 'thankyou',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-thankyou-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-thankyou-icon-blk.png'
        },
        alt: 'Thank You',
      ...
      },
      {
        name: 'custom',
        images: {
          normal: '../public/demo23_files/buyer/images/occasion-custom-icon-wht.png',
          selected: '../public/demo23_files/buyer/images/occasion-custom-icon-blk.png'
        },
        alt: 'Custom',
