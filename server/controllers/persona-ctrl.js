  ...
  .exec(function(err, persona){
    ...
    mailgun.sendEmail(
      ...
      'From: gift-confirm@clique.cc' +
        ...
        '\n\nYour gift of '+ request.body.Amount +' is on it&#39;s way! With the CLIQUE Local Gift Card '+ request.body.To +' You can apply your gift toward purchases at numerous locally-owned merchants in the Long Beach area, including Doly&#39;s Delectables at 245 E Broadway, Long Beach, CA.'<br>'CLIQUE stands for...'<br>'Cooperative of Local Independent Quality Urban Establishments'<br>'Yes, that&#39;s a mouthful :-)'<br>'CLIQUE is a Localism Project.'<br>'Did you know three times more money stays in our local economy when we buy from local businesses instead of big chains? That translates to more local jobs, and more of the unique shops, eateries and other businesses that give our city it&#39;s character. Make a difference with your dollars and support independent merchants.'<br>'~ The Localism Team'<br>'Visit Localism.co to see what we&#39;re all about!'<br>'________________________________'<br>'GIFT RECEIPT'<br>+ date +' Amount: $'+ request.body.Amount +' Sent to Sheila at '+ request.body.PhoneNumber +' Transaction ID: '+ request.body.uniqueLink +' Transaction ID: '+ request.body.uniqueLink + ' ________________________________ '+<br>'235 E Broadway'<br>'Eighth Floor'<br>'Long Beach, CA 90802'<br>'© 2014 Localism Inc. All rights reserved.'<br>'Questions? Call is at (877) 752-1550 or email hello@localism.co'
,
